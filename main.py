...
WHISPER_EXE = os.path.join(PROJECT_DIR, "whisper.cpp", "main")
...
check_path(MODEL_PATH, "Whisper model")
check_path(WHISPER_EXE, "Whisper executable")
...
SAMPLE_SIZE = 10  # Adjust based on available files
...
# Step 4: Transcribe audio with Whisper.cpp
